...
const Aboutme = () => {
    return (
        ...
        <div
            ...
            <img src={homeImg} alt="Pankaj Kumar" class=" md:h-72 lg:h-[700px] max-sm:hidden"/>
            <div class="flex flex-col p-6 md:p-10 ">


                <h1 class="text-2xl mx-auto font-mono">Hi, It's Me</h1>

                <h1
                    class="text-sky-500 mx-auto text-4xl xl:text-6xl font-extrabold my-5">
                    PANKAJ KUMAR</h1>

                <h2 class="text-sm mx-auto lg:text-2xl font-bold mt-1 font-mono">Web Developer, Open Source</h2>

                <p class="xl:text-lg my-3 lg:my-6 text-justify lg:text-justify">I am a Web Developer and
                    Programmer. I am
                ...
                <div class="flex my-4 lg:my-1 mx-auto">
                    <a href="https://www.linkedin.com/in/pankajktech/"
                        ...
                        <i class="devicon-linkedin-plain colored mr-2 lg:m-4"></i>
                        LINKEDIN </a>

                    <a href="https://drive.google.com/file/d/1Aa1GoCjaPd2WUMESN_8j6q9KfM1Vl-iL/view" target="_blank"
                        class="rounded-sm flex items-center justify-center bg-slate-200 w-36 xl:w-60 h-10 m-1 ml-2 xl:m-5 text-lg xl:text-2xl font-bold text-slate-900 duration-300 p-2 drop-shadow-2xl shadow-lg shadow-slate-800 hover:scale-90"><i
                            class="fa-solid fa-paperclip m-2 lg:m-4"></i> RESUME </a>
                </div>
            </div>
        </div>
    </div>

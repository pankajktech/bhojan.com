...
const RestaurantCard = ({
  ...
  return (
    <div className="m-10 w-80 h-96  bg-white shadow-xl hover:scale-105 duration-500 cursor-pointer ">
      ...
      <div className="p-3">
        <h1 className="text-2xl text-sky-800 font-bold"> {name} </h1>
        <p className="my-2 text-sm">{cuisines.join(",")}</p>
        <div className="my-4">
          <span className="bg-green-600 ml-3 mr-14 px-2 text-sm text-white"><i class="fa-regular fa-star text-white fa-sm mr-1"></i>{avgRating}</span>

    ...
    <>
      <div className="bg-slate-900 bg-opacity-10 shadow-sm flex justify-evenly lg:justify-around items-center sticky top-0 z-10 p-3 backdrop-blur-md">
        ...
        <ul className="cursor-pointer flex ">
          <li className="mx-2 lg:mx-4 text-md hover:animate-pulse  hover:text-slate-800 font-bold duration-500">
            <Link to="/">Home</Link>
          </li>
          <li className="mx-2 lg:mx-4 text-md hover:animate-pulse  hover:text-slate-800 font-bold duration-500">
          ...
          <li className="mx-4 text-md  hover:animate-pulse  hover:text-slate-800 font-bold duration-500">
